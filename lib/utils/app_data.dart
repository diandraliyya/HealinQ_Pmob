...
class AppData {
  ...
  static List<CounselorModel> counselors = [
    CounselorModel(
      id: 1, name: 'Dr. Diandra Aliyya Khoirunisa, M.Psi',
      specialization: 'Psikolog Klinis', rating: 5.0, type: 'Both',
      ...
      yearsExperience: 8, priceOnline: 150000, priceOffline: 200000,
      isVerified: true, isAvailable: true,
    ),
    CounselorModel(
      id: 2, name: 'Dr. Jessica Atalya Kriswianto, M.Psi',
      specialization: 'Stress Management', rating: 4.5, type: 'Online',
      location: 'Online', bio: 'Spesialis manajemen stres dan konseling remaja.',
      yearsExperience: 5, priceOnline: 120000, priceOffline: 0,
      isVerified: true, isAvailable: true,
    ),
    CounselorModel(
      id: 3, name: 'Dr. Leon Kennedy, M.Psi',
      specialization: 'Anxiety & Depression', rating: 4.8, type: 'Both',
      location: 'Jl. Raya Darmo No.45, Surabaya',
      bio: 'Ahli dalam penanganan kecemasan dan depresi ringan hingga sedang.',
      yearsExperience: 10, priceOnline: 175000, priceOffline: 225000,
      isVerified: true, isAvailable: false,
    ),
    CounselorModel(
      id: 4, name: 'Dr. Maudy Ayunda, M.Psi',
      specialization: 'Self-Development', rating: 4.7, type: 'Both',
      location: 'Jl. Pemuda No.12, Surabaya',
      bio: 'Fokus pada pengembangan diri dan potensi personal.',
      yearsExperience: 6, priceOnline: 130000, priceOffline: 180000,
      isVerified: true, isAvailable: true,
    ),
    CounselorModel(
      id: 5, name: 'Dr. Ethan Winters, M.Psi',
      specialization: 'Trauma Healing', rating: 4.9, type: 'Offline',
      location: 'Jl. Basuki Rahmat No.88, Surabaya',
      bio: 'Spesialis trauma healing dan pemulihan emosional.',
      yearsExperience: 12, priceOnline: 0, priceOffline: 250000,
      isVerified: true, isAvailable: false,
    ),
    CounselorModel(
      id: 6, name: 'Dr. Lily Winters, M.Psi',
      specialization: 'Relationship Counseling', rating: 4.6, type: 'Both',
      location: 'Jl. Diponegoro No.33, Surabaya',
      bio: 'Konseling hubungan dan komunikasi interpersonal.',
      yearsExperience: 7, priceOnline: 140000, priceOffline: 190000,
      isVerified: true, isAvailable: false,
    ),
    CounselorModel(
      id: 7, name: 'Dr. Lady Dimitrescu, M.Psi',
      specialization: 'Child & Adolescent', rating: 4.4, type: 'Both',
      location: 'Jl. Rungkut No.55, Surabaya',
      bio: 'Psikolog anak dan remaja berpengalaman.',
      yearsExperience: 9, priceOnline: 160000, priceOffline: 210000,
      isVerified: true, isAvailable: false,
    ),
  ];

  // Mock Passion Questions
  ...
  // Mock Lyric of the Day
  static Map<String, String> lyricOfTheDay = {
    'title': 'Who Knows',
    'artist': 'Marilyn Monroe',
    'lyric': '"You\'re Pure, You\'re Kind (Let Me Know, Let Me Know, Let Me Know, Let Me) Mature, Divine (Let Me Know, Let Me Know, Let Me Know, Let Me) You Might Be Too Good For Me, Unattainable (Let Me Know, Let Me Know, Let Me Know, Let Me)"',
  };

  // Mock Journals
  static List<JournalModel> journals = [
    JournalModel(id: 1, title: 'I Hate My Life Lately...', content: 'Hari ini terasa sangat berat. Banyak hal yang menumpuk dan aku merasa overwhelmed.', moodTag: '😔', createdAt: DateTime.now()),
    JournalModel(id: 2, title: 'Finally, I Found My Passion...', content: 'Setelah mengisi kuis FYP, aku menemukan bahwa passionku ada di bidang pendidikan dan seni!', moodTag: '😊', createdAt: DateTime.now().subtract(const Duration(days: 1))),
    JournalModel(id: 3, title: 'People Always Leave. Don\'t Get...', content: 'Perasaan ini terus menghantui. Tapi aku tahu aku harus terus maju.', moodTag: '😢', createdAt: DateTime.now().subtract(const Duration(days: 2))),
  ];
}
