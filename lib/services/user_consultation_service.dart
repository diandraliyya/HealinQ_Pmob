...
class UserConsultationService {
  ...
  Future<List<UserCounselorModel>> getCounselors({
    ...
    try {
      ...
      /*
       * Ambil counselor yang benar-benar mempunyai
       * slot available di masa depan.
       */
      final List<dynamic> slotRows =
          await _client
      ...
      /*
       * Ambil akun counselor yang active.
       */
      ...
      /*
       * Ambil detail counselor yang approved
       * dan menyediakan jenis konsultasi terkait.
       */
      final List<dynamic> detailRows =
          await _client
      ...
      for (final dynamic rawProfile
        ...
        if (id.isEmpty || detail == null) {
          continue;
        }

        result.add(
          UserCounselorModel.fromMap(
            <String, dynamic>{
              'id': id,
              ...
              'location':
                  detail['location'],
              'bio':
                  detail['professional_bio'],
              'offers_online':
                  detail['offers_online'],
              'offers_offline':
                  detail['offers_offline'],
              'price_online':
                  detail['price_online'],
              'price_offline':
                  detail['price_offline'],
      ...
      result.sort(
        (
          ...
          return second.rating.compareTo(
            first.rating,
          );
        },
      );
  ...
  Future<List<ConsultationSlotModel>>
      getAvailableSlots(
    String counselorId,
    bool offline,
  ) async {
  ...
  String _translateError(
    ...
    if (message.contains(
      ...
      return 'Slot baru saja dipesan user lain. '
    ...
    if (message.contains(
      ...
      return 'Akunmu tidak aktif dan '
          'tidak dapat membuat booking.';
    }

    if (message.contains(
      'counselor tidak aktif',
    )) {
    ...
    if (message.contains(
      ...
      return 'Kamu tidak memiliki izin '
          'untuk mengakses data konsultasi.';
    }
